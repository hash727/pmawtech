...
const desc = "We are a leading solar energy solutions provider specializing in turnkey solar power plant installations across India. Our team delivers both Rooftop and Ground-Mount solar projects tailored to commercial, industrial, and utility clients."
const data = {heading:"What we offer", offer: [
                                     {dat:"Engineering, Procurement & Construction (EPC) Services"},
                                     {dat:"Custom Rooftop Solar Installations"},
                                     {dat:"Ground-Mounted Solar Farms"},
                                     {dat:"Hybrid Systems with Battery Storage"},
                                     {dat:"Operations & Maintenance (O&M)"},
...
const AboutPage = () => {
  ...
  return (
    ...
    //     </div>
    // </main>
    <AboutPageContent heading="About Us" description={desc} details={data} />
  );
};
